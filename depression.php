...
<head>
    ...
    <title>MindProbe Depression Test</title>
...
<p><br><br><br><br><br></p>
    ...
    <form id="DepressionForm" method="post" action="recommendation.php">
        <div class='container mt-sm-5 my-1'>
            <div class='question ml-sm-5 pl-sm-5 pt-2'>
            <div class="heading">
             <h2 style="text-align: center; margin-top: 0.25in;"><b>Depression</b></h2>
            </div>
                ...
                <div class='form_body'>
                    <div class='gform_page_fields'>
                        <div id='gform_fields_1' class='gform_fields top_label form_sublabel_below description_above validation_below'>
                            ...
                            $query = "SELECT * FROM questions WHERE disease_id = 1";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<legend class='question'>$question_id. $question_text <span class='gfield_required'><span class='gfield_required gfield_required_asterisk'>*</span></span></legend>";
                                    ...
                                    $options_query = "SELECT * FROM options WHERE question_id = $question_id AND disease_id = 1";
