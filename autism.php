...
<head>
    ...
    <title>MindProbe Autism Spectrum Test
    </title>
...
<p><br><br><br><br><br></p>
    ...
    <form id="DepressionForm" method="post" action="userdatastore.php">
        <div class='container mt-sm-5 my-1'>
            ...
            <div class="heading">
             <h2 style="text-align: center; margin-top: 0.25in;"><b>Autism Spectrum Disorder</b></h2><br>
            </div>
                ...
                <div class='form_body'>
                    <div class='gform_page_fields'>
                        <div id='gform_fields_1' class='gform_fields top_label form_sublabel_below description_above validation_below'>
                            ...
                            $query = "SELECT * FROM questions WHERE disease_id = 4";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $options_query = "SELECT * FROM options WHERE question_id = $question_id AND disease_id = 4";
